...
<!--                                </li>-->
                        ...
                        <li>
                            ...
                            <ul class="collapse nav flex-column ms-2" id="submenuParticipant" data-bs-parent="#menu">
                                ...
                                <li>
                                    <a :href="`/admin/export/participant-list/${conferenceId}?export_emails=1`" id="export-participant-list-nav" class="nav-link px-0" target="_blank"> <span class="d-none d-sm-inline">Export participant emails</span><span class="d-sm-none">PH</span></a>
                                </li>
<!--                                <li>-->
