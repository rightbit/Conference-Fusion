                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6 form-check">
                                ...
                                <label class="form-check-label" for="share_email">
                                    ...
                                    <small>(Optional, to help with collaboration before the conference)</small>
                                </label>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 form-check">
                                ...
                                <label class="form-check-label" for="terms">
                                    Agree to site <a href="/terms-and-policies" target="_blank">terms and policies</a> <small>(Required)</small>
                                </label>
